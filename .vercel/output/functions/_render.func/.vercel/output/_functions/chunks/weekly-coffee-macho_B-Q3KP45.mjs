const id = "weekly-coffee-macho.md";
						const collection = "posts";
						const slug = "weekly-coffee-macho";
						...
						const data = {title:"2024/05/05 早秋咖啡 ☕",pubDate:new Date(1715472000000),categories:["生活"]};
						const _internal = {
							type: 'content',
							filePath: "/Users/millieqiu/MillieDev/millie-blog/src/content/posts/weekly-coffee-macho.md",
							rawData: undefined,
						};
