...
let foreground = "#3A4750";
let background = "#FEFAF6";
...
export default defineConfig({
  ...
  theme: {
    ...
    fontFamily: {
      sans: '"Source Sans Pro","Roboto", "Noto Sans TC", "Helvetica","Helvetica Neue","Source Han Sans SC","Source Han Sans TC","PingFang SC","PingFang HK","PingFang TC",sans-serif',
